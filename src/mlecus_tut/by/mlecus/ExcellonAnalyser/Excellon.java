...
import mlecus_tut.by.mlecus.DrillList.IDrillFrame;
import mlecus_tut.by.mlecus.DrillList.IDrillList;
import mlecus_tut.by.mlecus.DrillToolMap.DrillToolMap;
import mlecus_tut.by.mlecus.DrillToolMap.IDrillToolMap;
...
public class Excellon {
    ...
    public boolean ParseHeader(IDrillToolMap drillToolMap) {
        //String s;
        s = SkipComments();
    ...
    public boolean ParseDrillFrame(IDrillToolMap drillToolMap, IDrillFrame df) {
    ...
    public boolean ParseExcellon(IDrillList drillList, IDrillToolMap drillToolMap) {
